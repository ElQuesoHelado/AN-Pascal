...
type
  ...
  public
    ...
    procedure sumVariable(index: integer; Value: real);
...
procedure TCustParse.sumVariable(index: integer; Value: real);
begin
  //FParser.Identifiers[index]:=FParser.Identifiers[index]+Value;
  identVar[index].asFloat:=identVar[index].asFloat+Value;
end;

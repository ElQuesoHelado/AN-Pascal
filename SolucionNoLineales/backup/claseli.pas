...
type
  ...
  clLinea=class
    private
      ...
      Metodo:Integer;
      ecua:String;
      function principal(izq: Real; dere:Real):Real;
...
{
       FParserSist.Identifiers.AddFloatVariable('x', variables[0]);
       FParserSist.Identifiers.AddFloatVariable('y', variables[1]);
       FParserSist.Identifiers.AddFloatVariable('z', variables[2]);
       FParserSist.Identifiers.AddFloatVariable('w', variables[3]);
 }
